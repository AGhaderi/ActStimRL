...
import sys
sys.path.append('..')
from Madule import simulation_same_lr_random_all_reward
...
simulation_same_lr_random_all_reward.set_true_all_parts(alpha_mu_arg=alpha_mu, alpha_sd_arg=alpha_sd,
...
for run in range(1, runNumber):
    ...
    simulation_same_lr_random_all_reward.simulate_data_true_params(simNumber=simNumber, runNumber= run)
