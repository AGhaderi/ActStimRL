...
# name of model
model3_name = 'tabel1_model3_complement_prob'
model5_name = 'tabel1_model5_complement_prob'
# The address of model 3 and model 5 in HC
pickelDir_model3_HC = f'{config.PROJECT_HIER_MODEL_DIR}/Tabel1/HC/{model3_name}_HC.pkl'
pickelDir_model5_HC = f'{config.PROJECT_HIER_MODEL_DIR}/Tabel1/HC/{model5_name}_HC.pkl'
# The address of model 3 and model 5 in PD
pickelDir_model3_PD = f'{config.PROJECT_HIER_MODEL_DIR}/Tabel1/PD/{model3_name}_PD.pkl'
pickelDir_model5_PD = f'{config.PROJECT_HIER_MODEL_DIR}/Tabel1/PD/{model5_name}_PD.pkl'
"""Loading the pickle file of model fit from the subject directory"""
loadPkl_model3_HC = model_utils.load_pickle(load_path=pickelDir_model3_HC)
loadPkl_model5_HC = model_utils.load_pickle(load_path=pickelDir_model5_HC)
loadPkl_model3_PD = model_utils.load_pickle(load_path=pickelDir_model3_PD)
loadPkl_model5_PD = model_utils.load_pickle(load_path=pickelDir_model5_PD)
...
sns.kdeplot(data=transfer_hier_weight_mu_model5_HC[0], ax=axs[0], color='grey', alpha=1, fill=True, linewidth=1, label='AV')
...
sns.kdeplot(data=transfer_hier_weight_mu_model5_PD[0], ax=axs[1], color='grey', alpha=1, fill=True, linewidth=1, label='AV')
...
if not os.path.isdir(f'{config.SCRATCH_HIER_MODEL_DIR}/Tabel1/'):
        os.makedirs(f'{config.SCRATCH_HIER_MODEL_DIR}/Tabel1/') 

fig.savefig(f'{config.SCRATCH_HIER_MODEL_DIR}/Tabel1/model1AND5AV_CV_OP_weighting.pdf')
