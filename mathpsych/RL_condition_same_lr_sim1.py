...
for subName in subList:
    ...
    for session in [1, 2]: # session
        ...
        if modelFit == True: 
            ...
            file_name = 'RL_condition_same_lr.stan' 
            ...
            pickelDir = mainScarch + '/stim/' + str(simNumber) + '/' + subName + '/sess-' + str(session) + '_RL_condition_same_lr_run'+str(runNumber)+'.pkl'
            if not os.path.isdir(mainScarch + '/stim/' + str(simNumber) + '/' + subName):
                 os.makedirs(mainScarch + '/stim/' + str(simNumber) + '/' + subName)            
        ...
        if not os.path.isdir(mainScarch  + '/stim/' + str(simNumber) + '/' + subName):
            os.makedirs(mainScarch  + '/stim/' + str(simNumber) + '/' + subName)            
        fig.savefig(mainScratch  + '/stim/' + str(simNumber) + '/' + subName + '/sess-' + str(session) + '_RL_condition_same_lr_run'+str(runNumber)+'.png', dpi=300)
