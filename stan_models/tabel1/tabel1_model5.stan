...
parameters {
    ...
    array[nParts, nConds] real z_weight;   // Individual Wieghing (unconstrained)
...
transformed parameters {
    ...
    array[nParts, nConds] real<lower=0, upper=1> transfer_weight;   // Individual Wieghing (constrained)  
