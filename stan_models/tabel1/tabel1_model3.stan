...
parameters {
    ...
    array[nConds] real hier_weight_mu;    // Mean Hierarchical Wieghting (unconstrained)
...
transformed parameters {
    ...
    array[nConds] real<lower=0, upper=1> transfer_hier_weight_mu;  // Hierarchical Wieghing (constrained)
