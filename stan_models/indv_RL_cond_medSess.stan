...
parameters {
    ...
    array[nParts, n_conds_alpha_pos, n_medSess_alpha_pos] real alpha_pos;        // Individual positive learning rate (unconstrained)
    array[nParts, n_conds_alpha_neg, n_medSess_alpha_neg] real alpha_neg;        // Individual negative learning rate (unconstrained)
    array[nParts, n_conds_weight, n_medSess_weight] real weight;                 // Individual weighting parameter (unconstrained)  
    array[nParts, n_conds_sensitivity, n_medSess_sensitivity] real sensitivity;  // Individual sensitivity (unconstrained) 
}
