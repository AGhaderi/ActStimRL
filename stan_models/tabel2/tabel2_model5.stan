...
transformed parameters {
    ...
    array[nParts, nConds] real<lower=0, upper=1> transfer_weight;      // Individual Wieghtening (constrained)
    array[nParts, nConds] real<lower=0> transfer_sensitivity;          // Individual Individual Sensitivity (constrained) 
    ...
    array[nConds] real<lower=0, upper=1> transfer_hier_weight_mu;      // Hierarchical Wieghting (constrained) 
