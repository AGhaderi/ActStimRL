...
pickelDir = subMainDirec + 'Model_secondOrder/hier/groups/cond_patient/hierRL_HC_PD_cond_group_Model2.pkl'
if modelFit == True: 
    ...
    file_name = '/mrhome/amingk/Documents/7TPD/ActStimRL/Model/stan_models/hier/HC_PD/hierRL_HC_PD_cond_group_Model2.stan' 
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/groups/cond_patient/hierRL_HC_PD_cond_group_Model2.png', dpi=300)
