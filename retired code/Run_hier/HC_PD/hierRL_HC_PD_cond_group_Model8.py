...
pickelDir = subMainDirec + 'Model_secondOrder/hier/groups/cond_patient/hierRL_HC_PD_cond_group_Model8.pkl'
if modelFit == True: 
    ...
    for c in range(0, n_chains):
        chaininit = {
            ...
            'hier_alphaAct_sd': np.random.uniform(.01, .05),
            'hier_alphaClr_sd': np.random.uniform(.01, .05),        
            'hier_weightAct_sd': np.random.uniform(.01, .05),
            'hier_sensitivity_sd': np.random.uniform(.01, .05),
        }
        initials.append(chaininit)   

    # Loading the RL Stan Model
    file_name = '/mrhome/amingk/Documents/7TPD/ActStimRL/Model/stan_models/hier/HC_PD/hierRL_HC_PD_cond_group_Model8.stan' 
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/groups/cond_patient/hierRL_HC_PD_cond_group_Model8.png', dpi=300)
