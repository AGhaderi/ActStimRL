...
pickelDir = subMainDirec + 'Model_secondOrder/hier/para_recov/para_recov_model3_sim_' + str(simNumber)+'.pkl'
if modelFit == True: 
    ...
    file_name = '/mrhome/amingk/Documents/7TPD/ActStimRL/Model/stan_models/hier/para_recov/para_recov_model3.stan' 
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/para_recov/para_recov_model3_sim_' + str(simNumber)+'.png', dpi=300)
