...
for session in [1, 2]: # session
    for reverse in [21, 14]: # two distinct environemnt
        for condition in ['Act', 'Clr']: # condition
            ...
            pickelDir = subMainDirec + 'Model_secondOrder/hier/' + 'cond-' + str(condition) + '_sess-' + str(session) + '_env-' + str(reverse) + '_Stan-hierRL_simple_transfer_group2.pkl'
            if modelFit == True: 
            ...
            fig.savefig(subMainDirec + 'Model_secondOrder/hier/' + 'cond-' + str(condition) + '_sess-' + str(session) + '_env-' + str(reverse) + '_Stan-hierRL_simple_transfer_group2.png', dpi=300)
