...
behAll_group = behAll[behAll['group']==1]
...
for reverse in [21, 14]: # two distinct environemnt
    for condition in ['Act', 'Clr']: # condition
        ...
        fig.savefig(subMainDirec + 'Model_secondOrder/hier/group1/' + 'cond-' + str(condition) + '_env-' + str(reverse) + '_Stan-hierRL_simple_transfer_group1.png', dpi=300)
