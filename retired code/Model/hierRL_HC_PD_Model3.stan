/* Model 3 assumes that there is meaningful effect across wieghtening parameter not other parameters as well as group labels {HC and PD}.
...
transformed parameters {
    ...
    for (p in 1:nParts) {
        for (g in 1:nGrps){
            transfer_alphaAct[p, g] = Phi(hier_alphaAct_mu[g] + z_alphaAct[p, g]*hier_alphaAct_sd[g]);
            transfer_alphaClr[p, g] = Phi(hier_alphaClr_mu[g] + z_alphaClr[p, g]*hier_alphaClr_sd[g]);
