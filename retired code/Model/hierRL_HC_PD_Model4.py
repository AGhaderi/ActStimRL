...
pickelDir = subMainDirec + 'Model_secondOrder/hier/groups/hierRL_HC_PD_Model4.pkl'
if modelFit == True: 
    ...
    file_name = '../stan_models/hier/hierRL_HC_PD_Model4.stan' 
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/groups/hierRL_HC_PD_Model4.png', dpi=300)
