...
alphaPush : Learning rate for Push reponse
alphaPull : Learning rate for Pull reponse
alphaYell : Learning rate for Yellow chosen
alphaBlue : Learning rate for Blue chosen
...
alphaPush[2,2] two Medication effect (OFF vs ON), two Conditions [Act, Clr]
alphaPull[2,2] two Medication effect (OFF vs ON), two Conditions [Act, Clr]
alphaYell[2,2] two Medication effect (OFF vs ON), two Conditions [Act, Clr]
alphaBlue[2,2] two Medication effect (OFF vs ON), two Conditions [Act, Clr]
...
if modelFit == True: 
    ...
    for c in range(0, n_chains):
        chaininit = {
            'z_alphaPush': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'z_alphaPull': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'z_alphaYell': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'z_alphaBlue': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
...
alphaPush = fit["transfer_hier_alphaPush_mu"] 
alphaPull = fit["transfer_hier_alphaPull_mu"] 
alphaYell = fit["transfer_hier_alphaYell_mu"] 
alphaBlue = fit["transfer_hier_alphaBlue_mu"] 
weight = fit["transfer_hier_weightAct_mu"] 
...
sns.histplot(alphaPush[0,0], kde=True, stat='density', bins=100)
sns.histplot(alphaPush[0,1], kde=True, stat='density', bins=100)
sns.histplot(alphaPush[1,0], kde=True, stat='density', bins=100)
sns.histplot(alphaPush[1,1], kde=True, stat='density', bins=100)
plt.title('Learning Rate for push reponse', fontsize=12)
plt.ylabel('Density', fontsize=12)
plt.xlabel(r'$ \alpha_{(push)} $', fontsize=14)
plt.legend(['OFF-Act', 'OFF-Clr', 'ON-Act', 'ON-Clr']) 


# Action Learning Rate
fig.add_subplot(rows, columns, 4)
sns.histplot(alphaPull[0,0], kde=True, stat='density', bins=100)
sns.histplot(alphaPull[0,1], kde=True, stat='density', bins=100)
sns.histplot(alphaPull[1,0], kde=True, stat='density', bins=100)
sns.histplot(alphaPull[1,1], kde=True, stat='density', bins=100)
plt.title('Learning Rate for pull reponse', fontsize=12)
plt.ylabel('Density', fontsize=12)
plt.xlabel(r'$ \alpha_{(pull)} $', fontsize=14)
plt.legend(['OFF-Act', 'OFF-Clr', 'ON-Act', 'ON-Clr']) 
# Action Learning Rate
fig.add_subplot(rows, columns, 5)
sns.histplot(alphaYell[0,0], kde=True, stat='density', bins=100)
sns.histplot(alphaYell[0,1], kde=True, stat='density', bins=100)
sns.histplot(alphaYell[1,0], kde=True, stat='density', bins=100)
sns.histplot(alphaYell[1,1], kde=True, stat='density', bins=100)
plt.title('Learning Rate for yellow chosen', fontsize=12)
plt.ylabel('Density', fontsize=12)
plt.xlabel(r'$ \alpha_{(yell)} $', fontsize=14)
plt.legend(['OFF-Act', 'OFF-Clr', 'ON-Act', 'ON-Clr']) 


# Action Learning Rate
fig.add_subplot(rows, columns, 6)
sns.histplot(alphaBlue[0,0], kde=True, stat='density', bins=100)
sns.histplot(alphaBlue[0,1], kde=True, stat='density', bins=100)
sns.histplot(alphaBlue[1,0], kde=True, stat='density', bins=100)
sns.histplot(alphaBlue[1,1], kde=True, stat='density', bins=100)
plt.title('Learning Rate for blue chosen', fontsize=12)
plt.ylabel('Density', fontsize=12)
plt.xlabel(r'$ \alpha_{(blue)} $', fontsize=14)
plt.legend(['OFF-Act', 'OFF-Clr', 'ON-Act', 'ON-Clr']) 
