/* Model 7 assumes that there are meaningful effect across condition and medication for color value learning and sensitivity parameters
but the weghtening parameters and action value learning have condition effect
