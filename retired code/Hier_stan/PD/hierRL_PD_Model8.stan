/* Model 2 assumes that there are meaningful effect across condition and medication for action value learning and sensitivity parameters
but the weghtening parameters and color value learning have condition effect
