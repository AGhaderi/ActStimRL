...
if modelFit == True: 
    ...
    generate_initials= {
            'hier_alpha_sd1': .05,        
            'hier_weight_sd1': .05,
            'z_alphaAct_pos1': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'z_alphaAct_neg1': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'z_alphaClr_pos1': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'z_alphaClr_neg1': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'z_weight1': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'hier_alpha_sd2': .05,        
            'hier_weight_sd2': .05,
            'z_alphaAct2': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'z_alphaClr2': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'z_weight2': np.random.uniform(-1, 1, size=(nParts, nMeds, nConds)),
            'transfer_sensitivity1': np.random.uniform(.1, .5, size=(nParts, nMeds, nConds)),
            'transfer_sensitivity2': np.random.uniform(.1, .5, size=(nParts, nMeds, nConds)),
