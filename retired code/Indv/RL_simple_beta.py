...
for session in [1, 2]: # session
    for condition in ['Act', 'Clr']: # condition
        ...
        pickelDir = subMainDirec + subName + '/model/indv/' + subName + '_cond-' + str(condition) + '_sess-' + str(session) + '_RL_simple_beta.pkl'
        if modelFit == True: 
            ...
            file_name = '/home/amingk/Documents/7TPD/ActStimRL/Model/stan_models/indv/RL_simple_beta.stan' 
        ...
        fig.savefig(subMainDirec + subName + '/model/indv/' + subName + '_cond-' + str(condition) + '_sess-' + str(session) + '_RL_simple_beta.png', dpi=300)
