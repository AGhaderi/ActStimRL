...
for subName in subList:
    ...
    for session in [1, 2]: # session
        ...
        if modelFit == True: 
            ...
            pickelDir = mainScarch + str(simNumber) + '/' + subName + '/sess-' + str(session) + '_RL_condition_same_lr_switch_amount_run'+str(runNumber)+'.pkl'
        ...
        if not os.path.isdir(mainScarch + str(simNumber) + '/' + subName):
            os.makedirs(mainScarch + str(simNumber) + '/' + subName)            
        fig.savefig(mainScratch + str(simNumber) + '/' + subName + '/sess-' + str(session) + '_RL_condition_same_lr_switch_amount_run'+str(runNumber)+'.png', dpi=300)
