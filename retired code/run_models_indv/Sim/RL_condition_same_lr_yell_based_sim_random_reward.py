...
for subName in subList:
    ...
    for session in [1, 2]: # session
        ...
        if modelFit == True: 
            ...
            file_name = '/home/amingk/Documents/7TPD/ActStimRL/Model/stan_models/indv/RL_condition_same_lr_yell_based.stan' 
            ...
            pickelDir = mainScarch + str(simNumber) + '/' + subName + '/sess-' + str(session) + '_RL_condition_same_lr_yell_based_random_reward_run'+str(runNumber)+'.pkl'
        ...
        if not os.path.isdir(mainScarch + str(simNumber) + '/' + subName):
            os.makedirs(mainScarch + str(simNumber) + '/' + subName)            
        fig.savefig(mainScratch + str(simNumber) + '/' + subName + '/sess-' + str(session) + '_RL_condition_same_lr_yell_based_random_reward_run'+str(runNumber)+'.png', dpi=300)
