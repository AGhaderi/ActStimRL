...
estimated_hier_alphaAct_pos_mu = fit["hier_alphaAct_pos_mu"].flatten() 
estimated_hier_alphaAct_neg_mu = fit["hier_alphaAct_neg_mu"].flatten() 
estimated_hier_alphaClr_pos_mu = fit["hier_alphaClr_pos_mu"].flatten() 
estimated_hier_alphaClr_neg_mu = fit["hier_alphaClr_neg_mu"].flatten() 
estimated_hier_weight_mu = fit["hier_weight_mu"] 
estimated_hier_sensitivity_mu = fit["hier_sensitivity_mu"].flatten()
...
sns.histplot(estimated_hier_weight_mu[0], kde=True, stat='density', bins=100)
sns.histplot(estimated_hier_weight_mu[1], kde=True, stat='density', bins=100)
...
sns.histplot(estimated_hier_sensitivity_mu, kde=True, stat='density', bins=100)
...
sns.histplot(estimated_hier_alphaAct_pos_mu, kde=True, stat='density', bins=100)
...
sns.histplot(estimated_hier_alphaClr_pos_mu, kde=True, stat='density', bins=100)
...
sns.histplot(estimated_hier_alphaAct_neg_mu, kde=True, stat='density', bins=100)
...
sns.histplot(estimated_hier_alphaClr_neg_mu, kde=True, stat='density', bins=100)
...
# STD Action Learning Rate
fig.add_subplot(rows, columns, 8)
sns.histplot(estimated_hier_alpha_sd, kde=True, stat='density', bins=100)
plt.title(f'{partcipant_group}- weighting-std',  fontsize=18)
plt.ylabel('Density',  fontsize=18)
plt.xlabel(r'$STD$',  fontsize=18)
plt.yticks(fontsize=20)
plt.xticks(fontsize=20)
...
plt.title(f'{partcipant_group}- sensitivity- std',  fontsize=18)
plt.ylabel('Density',  fontsize=18)
plt.xlabel(r'$STD$',  fontsize=18)
plt.yticks(fontsize=20)
plt.xticks(fontsize=20)
