...
#  read raw behavioral data with grand truth directory
PROJECT_RAW_BEH_ALL_PARAMETER_GRAND_TRUTTH_DIR = f"{PROJECT_BEH_ALL_DATA_DIR}/simulation" 
#  write raw behavioral data with grand truth directory
SCRATCH_RAW_BEH_ALL_PARAMETER_GRAND_TRUTTH_DIR = f"{SCRATCH_BEH_ALL_DATA_DIR}/simulation" 
