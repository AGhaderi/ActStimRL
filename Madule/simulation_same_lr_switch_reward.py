        ...
        for subName in subList:
            for session in [1,2]:
                for reverse in [14, 21]:
                    if subName!='sub-010' or session!=2 or reverse!=21:
                        # yellow and pushed correct for Color condition
                        yellowCorrect_stim = rawBehAll[(rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Stim') &(rawBehAll['reverse']==reverse)]['yellowCorrect'].to_numpy()
                        yellowOnLeftSide_stim = rawBehAll[(rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Stim') &(rawBehAll['reverse']==reverse)]['yellowOnLeftSide'].to_numpy()
                        leftCanBePushed_stim = rawBehAll[(rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Stim') &(rawBehAll['reverse']==reverse)]['leftCanBePushed'].to_numpy()
                        indicator_in_stim = yellowOnLeftSide_stim==leftCanBePushed_stim
                        # yellow and pushed correct for Action condition
                        pushCorrect_act = rawBehAll[(rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Act') &(rawBehAll['reverse']==reverse)]['pushCorrect'].to_numpy()
                        yellowOnLeftSide_act = rawBehAll[(rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Act') &(rawBehAll['reverse']==reverse)]['yellowOnLeftSide'].to_numpy()
                        leftCanBePushed_act = rawBehAll[(rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Act') &(rawBehAll['reverse']==reverse)]['leftCanBePushed'].to_numpy()
                        indicator_in_act = yellowOnLeftSide_act==leftCanBePushed_act 

                        
                        # substitude yellow and pushed correct in Color and Action condition
                        rawBehAll.loc[((rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Stim') &(rawBehAll['reverse']==reverse)), 'yellowCorrect'] = pushCorrect_act
                        rawBehAll.loc[((rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Stim') &(rawBehAll['reverse']==reverse)), 'pushCorrect'] = (indicator_in_stim==pushCorrect_act).astype(int)

                        rawBehAll.loc[((rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Act') &(rawBehAll['reverse']==reverse)), 'pushCorrect'] = yellowCorrect_stim
                        rawBehAll.loc[((rawBehAll['sub_ID']==subName)& (rawBehAll['session']==session) &(rawBehAll['block']=='Act') &(rawBehAll['reverse']==reverse)), 'yellowCorrect'] = (indicator_in_act==yellowCorrect_stim).astype(int)
