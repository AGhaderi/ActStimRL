...
if modelFit == True: 
    ...
    for c in range(0, nChains):
        chaininit = {
            ...
            'sensitivity_sd': np.random.uniform(.001, .002),
            ...
            'transf_sensitivity_hier': np.random.uniform(.001, .002, size=(nSes)),
            ...
            'transf_sensitivity': np.random.uniform(.001, .002, size=(nParts, nSes))
        }
