...
pickelDir = subMainDirec + subName + '/' + str(simNumber) + '/' + subName  +'_RL_indv_2_sim.pkl'
if modelFit == True: 
...
transf_weightAct = fit["transf_weightAct"] 
transf_sensitivity = fit["transf_sensitivity"] 
transf_alphaAct = fit["transf_alphaAct"] 
transf_alphaClr = fit["transf_alphaClr"] 
...
plots.plot_posterior(x=transf_weightAct[0,0], 
                     ax=ax, 
                     trueValue=trueValue, 
...
plots.plot_posterior(x=transf_weightAct[0,1], 
                     ax=ax, 
                     trueValue=trueValue, 
...
plots.plot_posterior(x=transf_weightAct[1,0], 
                     ax=ax, 
                     trueValue=trueValue, 
...
plots.plot_posterior(x=transf_weightAct[1,1], 
                     ax=ax, 
                     trueValue=trueValue, 
...
fig.savefig(subMainDirec + subName + '/' + str(simNumber) + '/' + subName  +'_RL_indv_2_weightening_sim.png', dpi=300)
...
plots.plot_posterior(x=transf_sensitivity[0], 
                     ax=ax, 
                     trueValue=trueValue, 
...
ax = plt.gca()
trueValue = np.unique(data.loc[data['session']==1]['beta'])
plots.plot_posterior(x=transf_sensitivity[1], 
                     ax=ax, 
                     trueValue=trueValue, 
                     title = subName + ',Ses 1, Weightening',
                     ylabel = 'Density',
...
fig.savefig(subMainDirec + subName + '/' + str(simNumber) + '/' + subName  +'_RL_indv_2_beta_sim.png', dpi=300)
...
plots.plot_posterior(x=transf_alphaAct[0,0], 
                     ax=ax, 
                     trueValue=trueValue, 
...
plots.plot_posterior(x=transf_alphaAct[0,1], 
                     ax=ax, 
                     trueValue=trueValue, 
...
plots.plot_posterior(x=transf_alphaAct[1,0], 
                     ax=ax, 
                     trueValue=trueValue, 
...
plots.plot_posterior(x=transf_alphaAct[1,1], 
                     ax=ax, 
                     trueValue=trueValue, 
...
fig.savefig(subMainDirec + subName + '/' + str(simNumber) + '/' + subName  +'_RL_indv_2_alphaAct_sim.png', dpi=300)
...
plots.plot_posterior(x=transf_alphaClr[0,0], 
                     ax=ax, 
                     trueValue=trueValue, 
...
plots.plot_posterior(x=transf_alphaClr[0,1], 
                     ax=ax, 
                     trueValue=trueValue, 
...
plots.plot_posterior(x=transf_alphaClr[1,0], 
                     ax=ax, 
                     trueValue=trueValue, 
...
plots.plot_posterior(x=transf_alphaClr[1,1], 
                     ax=ax, 
                     trueValue=trueValue, 
...
fig.savefig(subMainDirec + subName + '/' + str(simNumber) + '/' + subName  +'_RL_indv_2_alphaClr_sim.png', dpi=300)
