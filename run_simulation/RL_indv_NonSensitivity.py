...
pickelDir = subMainDirec + subName + '/' + str(simNumber) + '/' + subName  +'_RL_indv_NonSensitivity_sim.pkl'
if modelFit == True: 
    ...
    file_name = '../stan_models/RL_indv_NonSensitivity.stan' 
...
fig.savefig(subMainDirec + subName + '/' + str(simNumber) + '/' + subName  +'_RL_indv_NonSensitivity_weightening_sim.png', dpi=300)
...
fig.savefig(subMainDirec + subName + '/' + str(simNumber) + '/' + subName  +'_RL_indv_NonSensitivity_alphaAct_sim.png', dpi=300)
...
fig.savefig(subMainDirec + subName + '/' + str(simNumber) + '/' + subName  +'_RL_indv_NonSensitivity_alphaClr_sim.png', dpi=300)
