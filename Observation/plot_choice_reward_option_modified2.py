...
for subName in subList:
    ...
    #save file name
    saveFile = subMainDirec + subName + '/' + subName + '_achieva7t_task-DA_beh_modified2.png'
    # Plot by a pre implemented madule
    plots.plotChosenCorrect_modofied2(data = data, blocks = blocks, subName = subName, saveFile = saveFile)
