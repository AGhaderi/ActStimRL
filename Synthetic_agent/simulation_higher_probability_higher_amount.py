...
rand_prob_amt = np.random.binomial(1, .7, len(higher_prob))
...
hgiher_prob_amt.to_csv('Synthetic_agent/simulation_higher_probability_higher_amount.csv', index=False)
