...
model { 
    ...
    for (g in 1:nMeds_nSes){
        for (c in 1:nConds){
            hier_weight_mu[g,c] ~ normal(0,5);
            hier_alphaAct_pos_mu1[g,c] ~ normal(0,5);
            hier_alphaAct_neg_mu1[g,c] ~ normal(0,5);
            hier_alphaClr_pos_mu1[g,c] ~ normal(0,5);
            hier_alphaClr_neg_mu1[g,c] ~ normal(0,5);
            hier_sensitivity_mu[g,c] ~ normal(0,5);
        }
    }
    ...
    for (g in 1:nMeds_nSes){
        for (c in 1:nConds){
            hier_alphaAct_mu2[g,c] ~ normal(0,5);
            hier_alphaClr_mu2[g,c] ~ normal(0,5);
        }
    }
