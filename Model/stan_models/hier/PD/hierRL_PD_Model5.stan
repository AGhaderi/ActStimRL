/* Model 2 assumes that there are meaningful effect across condition for all participant and just there is also medication effect over weightening parameter.
...
parameters {
    ...
    array[nParts, nMeds, nConds] real z_weightAct;  // Wieghtening of Action Learning Value against to Color Learnig Value
