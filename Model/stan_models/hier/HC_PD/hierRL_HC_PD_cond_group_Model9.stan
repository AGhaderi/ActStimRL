/* Model 2 assumes that there are meaningful effect across condition and group for all parameters expect the weghtening parameters that has condition effect
