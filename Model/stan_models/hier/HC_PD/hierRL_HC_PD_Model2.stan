/* Model 2 assumes that there is no effect across latent parameters and but there is maningful effect across group labels {HC and PD}.
...
transformed parameters {
    ...
    for (p in 1:nParts) {
        for (g in 1:nGrps){
            ...
            transfer_weightAct[p, g] = Phi(hier_weightAct_mu[g] + z_weightAct[p, g]*hier_weightAct_sd[g]);
