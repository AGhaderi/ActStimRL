...
parameters {
    ...
    array[nConds] real hier_alpha_neg_mu;    // Mean Hierarchical Negative Learning rate 
    ...
    array[nParts, nConds] real z_alpha_neg;   // Negative Learning rate
...
transformed parameters {
    ...
    array[nParts, nConds] real<lower=0, upper=1> transfer_alpha_neg;   // Negative Learning rate  
    ...
    array[nConds] real<lower=0, upper=1> transfer_hier_alpha_neg_mu;   // Hierarchical Negative Learning rate
