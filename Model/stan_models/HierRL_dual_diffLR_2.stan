...
parameters {
    ...
    array[nConds] real hier_weight_mu;   // Mean Hierarchical Wieghtening of Action Learning Value 
    ...
    array[nParts, nConds] real z_weight;  // Wieghtening of Action Learning Value
