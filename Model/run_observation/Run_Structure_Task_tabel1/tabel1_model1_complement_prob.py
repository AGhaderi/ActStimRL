...
hier_alpha_mu = fit["transfer_hier_alpha_mu"].flatten()
...
plt.title('Hierarchical Weighting Parameter',  fontsize=18)
plt.legend(['Act', 'Clr'])
...
sns.histplot(hier_alpha_mu, kde=True, stat='density', bins=100)
plt.title('Hierarchical Learnign Rate',  fontsize=18)
plt.ylabel('Density',  fontsize=18)
