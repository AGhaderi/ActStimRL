...
pickelDir = f'{writeMainScarch}/Behavioral/{partcipant_group}/{model_name}.pkl'
if modelFit == True: 
    ...
    file_name = f'/mrhome/amingk/Documents/7TPD/ActStimRL/Model/stan_models/others/{model_name}.stan' 
    ...
    # Save Model Fit
    if not os.path.isdir(f'{writeMainScarch}/Behavioral/{partcipant_group}/'):
            os.makedirs(f'{writeMainScarch}/Behavioral/{partcipant_group}/') 
    # Save Model Fit
...
fig.savefig(f'{writeMainScarch}/Behavioral/{partcipant_group}/{model_name}.png', dpi=500)
