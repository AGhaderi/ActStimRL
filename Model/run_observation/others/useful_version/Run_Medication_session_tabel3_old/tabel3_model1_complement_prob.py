...
if modelFit == True: 
    ...
    for c in range(0, n_chains):
        chaininit = {
            'z_alphaAct_pos': np.random.uniform(0, .5, size=(nParts, nMeds_nSes, nConds)),
            'z_alphaAct_neg': np.random.uniform(0, .5, size=(nParts, nMeds_nSes, nConds)),
            'z_alphaClr_pos': np.random.uniform(0, .5, size=(nParts, nMeds_nSes, nConds)),
            'z_alphaClr_neg': np.random.uniform(0, .5, size=(nParts, nMeds_nSes, nConds)),
            'z_sensitivity': np.random.uniform(0, .1, size=(nParts, nMeds_nSes, nConds)),
