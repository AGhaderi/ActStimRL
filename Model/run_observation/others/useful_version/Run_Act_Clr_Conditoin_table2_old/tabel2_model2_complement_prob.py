...
if modelFit == True: 
    ...
    for c in range(0, n_chains):
        chaininit = {
            ...
            'transfer_sensitivity': np.random.uniform(.03, .07, size=(nParts, nConds))
        }
...
hier_weight_mu = fit["transfer_hier_weight_mu"].flatten()  
...
sns.histplot(hier_weight_mu, kde=True, stat='density', bins=100)
