...
subMainDirec = '/mnt/projects/7TPD/bids/derivatives/fMRI_DA/Behavioral_modeling/BehData/'
...
if modelFit == True: 
    ...
    for c in range(0, n_chains):
        chaininit = {
            'hier_alpha_sd1': .05,        
            'hier_weight_sd': .05,
            'z_alphaAct_pos1': np.random.uniform(-1, 1, size=(nParts, nMeds_nSes, nConds)),
            'z_alphaAct_neg1': np.random.uniform(-1, 1, size=(nParts, nMeds_nSes, nConds)),
            'z_alphaClr_pos1': np.random.uniform(-1, 1, size=(nParts, nMeds_nSes, nConds)),
            'z_alphaClr_neg1': np.random.uniform(-1, 1, size=(nParts, nMeds_nSes, nConds)),
            'z_weight': np.random.uniform(-1, 1, size=(nParts, nMeds_nSes, nConds)),
            'hier_alpha_sd2': .05,        
            'z_alphaAct2': np.random.uniform(-1, 1, size=(nParts, nMeds_nSes, nConds)),
            'z_alphaClr2': np.random.uniform(-1, 1, size=(nParts, nMeds_nSes, nConds)),
            'transfer_sensitivity': np.random.uniform(.1, .5, size=(nParts, nMeds_nSes, nConds))
        }
