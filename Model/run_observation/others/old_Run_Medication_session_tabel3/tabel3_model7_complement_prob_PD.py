...
pickelDir = f'{writeMainScarch}/Behavioral/Tabel3/{partcipant_group}/{model_name}.pkl'
...
if modelFit == True: 
    ...
    for c in range(0, n_chains):
        chaininit = {
            ...
            'z_alpha_neg': np.random.uniform(-1, 1, size=(nParts, nMeds_nSes)),
            ...
            'transfer_sensitivity': np.random.uniform(.3, .7, size=(nParts, nMeds_nSes))
        }
...
sns.histplot(hier_alpha_neg_mu[0], kde=True, stat='density', bins=100)
sns.histplot(hier_alpha_neg_mu[1], kde=True, stat='density', bins=100)
...
fig.savefig(f'{writeMainScarch}/Behavioral/Tabel3/{partcipant_group}/{model_name}.png', dpi=500)
