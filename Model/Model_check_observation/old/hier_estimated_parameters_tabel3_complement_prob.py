...
# save
fig.savefig(f'{writewriteMainScarch}/Behavioral/Tabel3/{model_name}_irrelavant_lr.png', dpi=500)
...
# save
fig.savefig(f'{writewriteMainScarch}/Behavioral/Tabel3/{model_name}_relavant_lr.png', dpi=500)
...
axs[1].set_xlim(0,1)
# bf for color
i = np.mean((transfer_hier_weight_mu_PD[0,1] - transfer_hier_weight_mu_PD[1,1])>0)
bf_Clr = i/(1-i)
axs[1].text(.3, .80,  'bf-PD-Clr={:.2f}'.format(bf_Clr), transform=axs[1].transAxes, fontsize=8)
# bf for action
i = np.mean((transfer_hier_weight_mu_PD[0,0] - transfer_hier_weight_mu_PD[1,0])>0)
bf_Act = i/(1-i)
axs[1].text(.3, .70,  'bf-PD-Act={:.2f}'.format(bf_Act), transform=axs[1].transAxes, fontsize=8)
 ...
 ############################# Disease effect
# bf for action
i = np.mean((transfer_hier_weight_mu_PD[0,0]-np.concatenate([transfer_hier_weight_mu_HC[0,0][random.sample(range(0,24000), 12000)], transfer_hier_weight_mu_HC[1,0][random.sample(range(0,24000), 12000)]]))>0)
bf_Act = (1-i)/i
axs[1].text(.3, .50,  'bf-Act={:.2f}'.format(bf_Act), transform=axs[1].transAxes, fontsize=8)
# bf for action
i = np.mean((transfer_hier_weight_mu_PD[0,1]-np.concatenate([transfer_hier_weight_mu_HC[0,1][random.sample(range(0,24000), 12000)], transfer_hier_weight_mu_HC[1,1][random.sample(range(0,24000), 12000)]]))>0)
bf_Act = i/(1-i)
...
# save
fig.savefig(f'{writewriteMainScarch}/Behavioral/Tabel3/{model_name}_weighting.png', dpi=500)
