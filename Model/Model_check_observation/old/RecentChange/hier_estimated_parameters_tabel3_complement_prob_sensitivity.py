...
sns.kdeplot(data=transfer_hier_sensitivity_mu_PD[0,0], ax=axs[1], color='red', alpha=.3, fill=True, linewidth=.1, label='Act-OFF')
sns.kdeplot(data=transfer_hier_sensitivity_mu_PD[0,1], ax=axs[1], color='red', alpha=.5, fill=True, linewidth=.1, label='Act-ON')
sns.kdeplot(data=transfer_hier_sensitivity_mu_PD[1,0], ax=axs[1], color='red', alpha=.7, fill=True, linewidth=.1, label='Clr-OFF')
sns.kdeplot(data=transfer_hier_sensitivity_mu_PD[1,1], ax=axs[1], color='red', alpha=1, fill=True, linewidth=.1, label='Clr-ON')
