...
for partcipant_group in ['HC', 'PD']:
    # name of table
    tabel = 'Tabel3'
    list_model = ['tabel3_model1_complement_prob', 'tabel3_model2_complement_prob', 'tabel3_model3_complement_prob',
                  'tabel3_model4_complement_prob', 'tabel3_model5_complement_prob', 'tabel3_model6_complement_prob',
                  'tabel3_model7_complement_prob']
    ...
    ## waic
    print(f'WAIC in {partcipant_group} for: ',tabel, ' : ', waic)
    #dwaic
    ...
    print(f'weight in {partcipant_group}  for: ',tabel, ' : ', weight)
