...
pickelDir_HC = f'{writewriteMainScarch}/Behavioral/Tabel3/HC/tabel3_model2_complement_prob_HC.pkl'
...
sns.kdeplot(data=transfer_hier_sensitivity_mu_HC_sess1, ax=axs[0], color='blue', alpha=.5, fill=True, linewidth=.5, label='See1')
sns.kdeplot(data=transfer_hier_sensitivity_mu_HC_sess2, ax=axs[0], color='blue', alpha=.9, fill=True, linewidth=.5, label='See2')
...
sns.kdeplot(data=transfer_hier_sensitivity_mu_HC_Act, ax=axs[1], color='blue', alpha=.5, fill=True, linewidth=.5, label='Act')
sns.kdeplot(data=transfer_hier_sensitivity_mu_HC_Clr, ax=axs[1], color='blue', alpha=.9, fill=True, linewidth=.5, label='Clr')
...
sns.kdeplot(data=transfer_hier_sensitivity_mu_PD_OFF, ax=axs[2], color='red', alpha=.5, fill=True, linewidth=.5, label='OFF')
sns.kdeplot(data=transfer_hier_sensitivity_mu_PD_ON, ax=axs[2], color='red', alpha=.9, fill=True, linewidth=.5, label='ON')
...
sns.kdeplot(data=transfer_hier_sensitivity_mu_PD_Act, ax=axs[3], color='red', alpha=.5, fill=True, linewidth=.5, label='Act')
sns.kdeplot(data=transfer_hier_sensitivity_mu_PD_Clr, ax=axs[3], color='red', alpha=.9, fill=True, linewidth=.5, label='Clr')
