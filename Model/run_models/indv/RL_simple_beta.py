...
for session in [1, 2]: # session
    for reverse in [21, 14]: # two distinct environemnt
        for condition in ['Act', 'Clr']: # condition
            ...
            pickelDir = subMainDirec + subName + '/model/indv/' + subName + '_cond-' + str(condition) + '_sess-' + str(session) + '_env-' + str(reverse) + '_StanRL_simple_beta.pkl'
            if modelFit == True: 
                ...
                file_name = '../stan_models/RL_simple_beta.stan' 
            ...
            fig.savefig(subMainDirec + subName + '/model/indv/' + subName + '_cond-' + str(condition) + '_sess-' + str(session) + '_env-' + str(reverse) + '_StanRL_simple_beta.png', dpi=300)
