...
for subName in subList_PD:
    ...
    pickelDir = mainScarch  + 'realdata/' + subName + '/model/indv/RL_' + str(cond_act_stim)+'_medication_same_lr_model5.pkl'
    if modelFit == True: 
    ...
    fig.savefig(mainScarch  + 'realdata/' + subName + '/model/indv/RL_' + str(cond_act_stim)+'_medication_same_lr_model5.png', dpi=300)
