...
for subName in subList_PD:
    ...
    pickelDir = mainScarch  + 'realdata/' + subName + '/model/indv/RL_' + str(cond_act_stim)+'_medication_same_lr_model2.pkl'
    ...
    if modelFit == True: 
        ...
        file_name = '/home/amingk/Documents/7TPD/ActStimRL/Model/stan_models/indv/RL_same_lr_model2.stan' 
    ...
    fig.savefig(mainScarch  + 'realdata/' + subName + '/model/indv/RL_' + str(cond_act_stim)+'_medication_same_lr_model2.png', dpi=300)
