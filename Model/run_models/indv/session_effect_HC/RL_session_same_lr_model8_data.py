...
for subName in subList_PD:
    ...
    pickelDir = mainScarch  + 'realdata/' + subName + '/model/indv/RL_' + str(cond_act_stim)+'_session_same_lr_model8.pkl'
    if modelFit == True: 
    ...
    fig.savefig(mainScarch  + 'realdata/' + subName + '/model/indv/RL_' + str(cond_act_stim)+'_session_same_lr_model8.png', dpi=300)
