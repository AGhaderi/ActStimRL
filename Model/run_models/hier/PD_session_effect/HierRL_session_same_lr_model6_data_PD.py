...
pickelDir = mainScarch  + 'realdata/hier/PD/medication/HierRL_' + str(cond_act_stim)+'_medication_same_lr_model6.pkl'
if modelFit == True: 
...
fig.savefig(mainScarch  + 'realdata/hier/PD/medication/HierRL_' + str(cond_act_stim)+'_medication_same_lr_model6.png', dpi=300)
