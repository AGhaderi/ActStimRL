...
pickelDir = subMainDirec + 'Model_secondOrder/hier/group2/pool/hierRL_HC_Model1.pkl'
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/group2/pool/hierRL_HC_Model1.png', dpi=300)
