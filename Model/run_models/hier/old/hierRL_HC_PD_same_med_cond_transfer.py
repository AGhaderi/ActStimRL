...
pickelDir = subMainDirec + 'Model_secondOrder/hier/groups/Stan-hierRL_HC_PD_same_med_cond_transfer.pkl'
if modelFit == True: 
    ...
    dataStan = {'N':behAll.shape[0],  
                ...
                'nConds':nConds,
                'nGrps':nGrps,
                'medication':np.array(behAll.group).astype(int),
    ...
    for c in range(0, 1):
        chaininit = {
            'z_alphaAct': np.random.uniform(-1, 1, size=(nParts, nGrps, nMeds, nConds)),
            'z_alphClr': np.random.uniform(-1, 1, size=(nParts, nGrps, nMeds, nConds)),        
            'z_weightAct': np.random.uniform(-1, 1, size=(nParts, nGrps, nMeds, nConds)),
            'z_sensitivity': np.random.uniform(-1, 1, size=(nParts, nGrps, nMeds, nConds)),
    ...
    file_name = '../stan_models/hier/hierRL_HC_PD_same_med_cond_transfer.stan' 
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/groups/Stan-hierRL_HC_PD_same_med_cond_transfer.png', dpi=300)
