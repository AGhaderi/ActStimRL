...
behAll = pd.read_csv('/mrhome/amingk/Documents/7TPD/ActStimRL/Simulation/simulation_chosing_left_right.csv')
...
pickelDir = subMainDirec + 'Model_secondOrder/hier/sim/simulation_chosing_left_right_Model1.pkl'
if modelFit == True: 
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/sim/simulation_chosing_left_right_Model1.png', dpi=300)
