...
nEnvs = 2
behAll_group.reverse = behAll_group.reverse.replace([21, 14], [1, 2])

# read all conditions data for a specifit participant
# The adrees name of pickle file
pickelDir = subMainDirec + 'Model_secondOrder/hier/group13/med_cond_env/Stan-hierRL_med_cond_env_transfer_group13.pkl'
if modelFit == True: 
    ...
    dataStan = {'N':behAll_group.shape[0],  
                ...
                'nConds':nConds,
                'nEnvs':nEnvs,
                'medication':np.array(behAll_group.group).astype(int),
                'condition':np.array(behAll_group.block).astype(int),
                'environment':np.array(behAll_group.reverse).astype(int),
                'p_push_init':.5, 
                'p_yell_init':.5}
    # initial sampling
    initials = [] 
    for c in range(0, n_chains):
        chaininit = {
            'z_alphaAct': np.random.normal(-1, 1, size=(nParts, nMeds, nConds, nEnvs)),
            'z_alphClr': np.random.normal(-1, 1, size=(nParts, nMeds, nConds, nEnvs)),        
    ...
    file_name = '../stan_models/hier/hierRL_med_cond_env_transfer.stan' 
...
sns.histplot(alphaAct_[0, 0, 0], kde=True, stat='density', bins=100)
sns.histplot(alphaAct_[0, 0, 1], kde=True, stat='density', bins=100)
sns.histplot(alphaAct_[0, 0, 0], kde=True, stat='density', bins=100)
sns.histplot(alphaAct_[0, 1, 1], kde=True, stat='density', bins=100)
sns.histplot(alphaAct_[1, 0, 0], kde=True, stat='density', bins=100)
sns.histplot(alphaAct_[1, 0, 1], kde=True, stat='density', bins=100)
sns.histplot(alphaAct_[1, 0, 0], kde=True, stat='density', bins=100)
sns.histplot(alphaAct_[1, 1, 1], kde=True, stat='density', bins=100)
...
sns.histplot(alphaClr_[0, 0, 0], kde=True, stat='density', bins=100)
sns.histplot(alphaClr_[0, 0, 1], kde=True, stat='density', bins=100)
sns.histplot(alphaClr_[0, 0, 0], kde=True, stat='density', bins=100)
sns.histplot(alphaClr_[0, 1, 1], kde=True, stat='density', bins=100)
sns.histplot(alphaClr_[1, 0, 0], kde=True, stat='density', bins=100)
sns.histplot(alphaClr_[1, 0, 1], kde=True, stat='density', bins=100)
sns.histplot(alphaClr_[1, 0, 0], kde=True, stat='density', bins=100)
sns.histplot(alphaClr_[1, 1, 1], kde=True, stat='density', bins=100)
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/group13/med_cond_env/Stan-hierRL_med_cond_block_transfer_group13.png', dpi=300)
