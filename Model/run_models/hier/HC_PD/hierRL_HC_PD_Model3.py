...
pickelDir = subMainDirec + 'Model_secondOrder/hier/groups/hierRL_HC_PD_Model3.pkl'
if modelFit == True: 
    ...
    file_name = '../stan_models/hier/hierRL_HC_PD_Model3.stan' 
...
plt.legend(['Act-HC', 'Act-PD', 'Clr-HC', 'Clr-PD'])
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/groups/hierRL_HC_PD_Model3.png', dpi=300)
