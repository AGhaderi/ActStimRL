...
pickelDir = subMainDirec + 'Model_secondOrder/hier/groups/hierRL_HC_PD_Model1.pkl'
if modelFit == True: 
    ...
    for c in range(0, n_chains):
        chaininit = {
            ...
            'transfer_hier_alphaAct_mu':np.random.uniform(.6, .9),
            'transfer_hier_alphaClr_mu':np.random.uniform(.1, .4),
            'transfer_hier_weightAct_mu':np.random.uniform(.1, .9),
            'transfer_hier_sensitivity_mu':np.random.uniform(.1, 1),
            'transfer_hier_alphaAct_sd': np.random.uniform(.01, .1),
    ...
    file_name = '../stan_models/hier/hierRL_HC_PD_Model1.stan' 
...
plt.title('Weightening for all conditins and groups', fontsize=12)
...
plt.title('Sensitivity for all conditins and groups', fontsize=12)
plt.ylabel('Density', fontsize=12)
...
plt.title('Action Learning Rate for all conditins and groups', fontsize=12)
plt.ylabel('Density', fontsize=12)
...
plt.title('Color Learning Rate for all conditins and groups', fontsize=12)
plt.ylabel('Density', fontsize=12)
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/groups/hierRL_HC_PD_Model1.png', dpi=300)
