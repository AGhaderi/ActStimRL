...
pickelDir = mainScarch  + 'realdata/hier/session/HierRL_' + str(cond_act_stim)+'_session_same_lr_model6.pkl'
if modelFit == True: 
    ...
    file_name = '/mrhome/amingk/Documents/7TPD/ActStimRL/Model/stan_models/hier/HierRL_same_lr_model6.stan' 
...
fig.savefig(mainScarch  + 'realdata/hier/session/HierRL_' + str(cond_act_stim)+'_session_same_lr_model6.png', dpi=300)
