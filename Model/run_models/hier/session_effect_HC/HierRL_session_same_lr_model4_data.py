...
pickelDir = mainScarch  + 'realdata/hier/session/HierRL_' + str(cond_act_stim)+'_session_same_lr_model4.pkl'
if modelFit == True: 
    ...
    for c in range(0, n_chains):
        chaininit = {
            ...
            'z_weightAct': np.random.uniform(-1, 1, size=(nParts, nSess)),
    ...
    file_name = '/mrhome/amingk/Documents/7TPD/ActStimRL/Model/stan_models/hier/HierRL_same_lr_model4.stan' 
...
fig.savefig(mainScarch  + 'realdata/hier/session/HierRL_' + str(cond_act_stim)+'_session_same_lr_model4.png', dpi=300)
