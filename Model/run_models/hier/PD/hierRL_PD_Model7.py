...
pickelDir = subMainDirec + 'Model_secondOrder/hier/group13/pool/hierRL_PD_Model7.pkl'
if modelFit == True: 
    ...
    file_name = '/mrhome/amingk/Documents/7TPD/ActStimRL/Model/stan_models/hier/PD/hierRL_PD_Model7.stan' 
...
fig.savefig(subMainDirec + 'Model_secondOrder/hier/group13/pool/hierRL_PD_Model7.png', dpi=300)
